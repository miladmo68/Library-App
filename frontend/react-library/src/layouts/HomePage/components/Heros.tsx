    ...
    <div>
      <div className="d-none d-lg-block">
          ...
          <div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
            <div className="ml-2">
              ...
              <p className="lead">
                ...
                When it is to learn a new skill or grow within one, we will be
        ...
        <div className="row g-0">
          <div className="col-4 col-md-4 container d-flex justify-content-c3enter align-items-center">
            <div className="ml-2">
            ...
            <div className="col-image-left">
              <div className="mt-2">
                ...
                <p className="lead">
                  ...
                  reading. When it is to learn a new skill or grow within one,
